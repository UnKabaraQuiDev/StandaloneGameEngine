...
import lu.kbra.standalone.gameengine.cache.attrib.impl.SyntheticAttribArray;
import lu.kbra.standalone.gameengine.generated.gl_wrapper.GL_W;
import lu.kbra.standalone.gameengine.utils.gl.consts.BufferType;

public class SyntheticFloatAttribArray extends FloatAttribArray implements SyntheticAttribArray {

	public SyntheticFloatAttribArray(final String name, final int index, final int dataLength) {
	...
	public SyntheticFloatAttribArray(final String name, final int index, final int dataLength, final boolean _static) {
		super(name, index, null, _static);
		super.length = dataLength;
	}

	public SyntheticFloatAttribArray(final String name, final int index, final int dataLength, final boolean _static, final int divisor) {
