...
public class SyntheticMat4fAttribArray extends Mat4fAttribArray {
	...
	public SyntheticMat4fAttribArray(final String name, final int index, final int dataLength, final boolean iStatic, final int divisor) {
		super(name, index, null, iStatic, divisor);
		super.length = dataLength;
	}

	public SyntheticMat4fAttribArray(final String name, final int index, final int dataLength, final boolean iStatic) {
	...
	public SyntheticMat4fAttribArray(final String name, final int index, final int dataLength) {
