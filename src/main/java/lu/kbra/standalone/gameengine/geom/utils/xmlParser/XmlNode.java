package lu.kbra.standalone.gameengine.geom.utils.xmlParser;
...
public class XmlNode {
	...
	/**
	 * Gets the value of a certain attribute of the node. Returns {@code null} if
	 ...
	 * attribute. Used to get a specific child when there are multiple child nodes
	 ...
	 * @return The child node which has the correct name and the correct value for
	 ...
	 * @return A list of the child nodes with the given name. If none exist then an
