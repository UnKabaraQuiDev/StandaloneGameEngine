		...
		super(name, material,
				new Vec3fAttribArray(Mesh.ATTRIB_VERTICES_NAME, Mesh.ATTRIB_VERTICES_ID,
						new Vector3f[] {
								...
								new Vector3f(1f, 0, 1f).mul(size.x(), 0, size.y()).div(2),
								new Vector3f(-1f, 0, 1f).mul(size.x(), 0, size.y()).div(2) }),
				new UIntAttribArray(Mesh.ATTRIB_INDICES_NAME, Mesh.ATTRIB_INDICES_ID, new int[] { 0, 2, 1, 0, 3, 2 },
								...
								new AttribArray[] {
										new Vec3fAttribArray(Mesh.ATTRIB_NORMALS_NAME, Mesh.ATTRIB_NORMALS_ID,
												new Vector3f[] {
														...
														new Vector3f(0, 0, 1),
														new Vector3f(0, 0, 1) }),
										new Vec2fAttribArray(Mesh.ATTRIB_UVS_NAME, Mesh.ATTRIB_UVS_ID,
												new Vector2f[] {
														new Vector2f(0, 1),
														new Vector2f(1, 1),
														new Vector2f(1, 0),
		...
		super(name, material2,
				new Vec3fAttribArray(Mesh.ATTRIB_VERTICES_NAME, Mesh.ATTRIB_VERTICES_ID,
						new Vector3f[] {
								...
								new Vector3f(1f, 1f, 1f).mul(plane.project(size)).div(2),
								new Vector3f(-1f, 1f, -1f).mul(plane.project(size)).div(2) }),
				new UIntAttribArray(Mesh.ATTRIB_INDICES_NAME, Mesh.ATTRIB_INDICES_ID, new int[] { 0, 1, 2, 0, 2, 3 },
						BufferType.ELEMENT_ARRAY),
				new Vec3fAttribArray(Mesh.ATTRIB_NORMALS_NAME, Mesh.ATTRIB_NORMALS_ID,
