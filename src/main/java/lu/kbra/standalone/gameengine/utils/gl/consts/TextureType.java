...
public enum TextureType implements GLConstant {
	...
	// Base textures
	TXT1D(GL_W.GL_TEXTURE_1D, null),
	TXT2D(GL_W.GL_TEXTURE_2D, null),
	TXT3D(GL_W.GL_TEXTURE_3D, null),

	ARRAY1D(GL_W.GL_TEXTURE_1D_ARRAY, TXT1D),
	ARRAY2D(GL_W.GL_TEXTURE_2D_ARRAY, TXT2D),

	// Cubemaps
	CM_PX(GL_W.GL_TEXTURE_CUBE_MAP_POSITIVE_X, null),
	CM_NX(GL_W.GL_TEXTURE_CUBE_MAP_NEGATIVE_X, null),
	CM_PY(GL_W.GL_TEXTURE_CUBE_MAP_POSITIVE_Y, null),
	CM_NY(GL_W.GL_TEXTURE_CUBE_MAP_NEGATIVE_Y, null),
	CM_PZ(GL_W.GL_TEXTURE_CUBE_MAP_POSITIVE_Z, null),
	CM_NZ(GL_W.GL_TEXTURE_CUBE_MAP_NEGATIVE_Z, null),
	CUBE_MAP(GL_W.GL_TEXTURE_CUBE_MAP, null);
