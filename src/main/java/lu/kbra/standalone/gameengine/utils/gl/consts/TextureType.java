...
public enum TextureType implements GLConstant {
	...
	// Cubemaps
	CM_PX(GL_W.GL_TEXTURE_CUBE_MAP_POSITIVE_X, null), CM_NX(GL_W.GL_TEXTURE_CUBE_MAP_NEGATIVE_X, null),
	CM_PY(GL_W.GL_TEXTURE_CUBE_MAP_POSITIVE_Y, null), CM_NY(GL_W.GL_TEXTURE_CUBE_MAP_NEGATIVE_Y, null),
	CM_PZ(GL_W.GL_TEXTURE_CUBE_MAP_POSITIVE_Z, null), CM_NZ(GL_W.GL_TEXTURE_CUBE_MAP_NEGATIVE_Z, null),
	...
	public static boolean isCubemap(TextureType txtType) {
		return txtType == CM_PX || txtType == CM_NX || txtType == CM_PY || txtType == CM_NY || txtType == CM_PZ
				|| txtType == CM_NZ;
	}
