...
public enum TextureParameter implements GLConstant {
	...
	// Swizzle
	SWIZZLE_R(GL_W.GL_TEXTURE_SWIZZLE_R), SWIZZLE_G(GL_W.GL_TEXTURE_SWIZZLE_G), SWIZZLE_B(GL_W.GL_TEXTURE_SWIZZLE_B),
	SWIZZLE_A(GL_W.GL_TEXTURE_SWIZZLE_A),

	// Wrap
	WRAP_S(GL_W.GL_TEXTURE_WRAP_S), WRAP_T(GL_W.GL_TEXTURE_WRAP_T), WRAP_R(GL_W.GL_TEXTURE_WRAP_R),
	WRAP_VERTICAL(GL_W.GL_TEXTURE_WRAP_T), WRAP_HORIZONTAL(GL_W.GL_TEXTURE_WRAP_S), WRAP_DEPTH(GL_W.GL_TEXTURE_WRAP_R);
