...
public class FontAtlasGenerator {
	...
	public static final int[] DEFAULT_SIZES = new int[] { 8, 16, 32, 64, 128 };
	...
	public static void generateAtlases(File fontFilePath, int[] sizes, int firstChar, int lastChar) throws Exception {
		...
		for (int tileSize : sizes) {
			...
			final File outputFile = new File(Consts.BAKES_RES_DIR, "fonts/" + fontFilePath.getName() + "/" + tileSize + ".png");
	...
	public static void main(String[] args) throws Exception {
		for (final String font : new String[] { "QuinqueFive.ttf" }) {
			GlobalLogger.info("Generating font atlas for: " + font);
			generateAtlases(new File(Consts.FONTS_RES_DIR, font));
		}
	}
