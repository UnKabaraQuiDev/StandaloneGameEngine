 ...
 * position vector and a Quaternionf (rotation) so that these values can be
...
public class BoneTransform {
	 ...
	 * (bone-space) at a certain keyframe. For example, if this joint is at (5, 12,
	 * 0) in the model's coordinate system, and the parent of this joint is at (2,
	 * 8, 0), then the position of this joint relative to the parent is (3, 4, 0).
	 ...
	 * rotation. The rotation is applied by first converting the Quaternionf into a
	 ...
	 * as represented by the position and rotation in this instance, just in matrix
	 * form.
	 */
	 ...
	 * two transforms to interpolate. A progression value of 0 would return a
	 * transform equal to "frameA", a value of 1 would return a transform equal to
	 * "frameB". Everything else gives a transform somewhere in-between the two.
	 * @return
	 */
