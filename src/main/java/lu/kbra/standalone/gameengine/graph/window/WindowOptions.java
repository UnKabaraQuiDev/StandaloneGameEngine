...
public class WindowOptions {
	...
	public WindowOptions(Properties props, String pathPrefix) {
		...
		this.logging = PCUtils.parseBoolean(props.getProperty(pathPrefix + ".logging"), false);
		this.debug = PCUtils.parseBoolean(props.getProperty(pathPrefix + ".debug"), false);
		this.visible = PCUtils.parseBoolean(props.getProperty(pathPrefix + ".visible"), true);
	}
